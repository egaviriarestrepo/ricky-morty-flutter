...
// 🌎 Project imports:
import 'package:rick_and_morty/share/constants/store_key.dart';
import 'package:rick_and_morty/share/model/token.dart';
...
class TokenRepository implements TokenRepositoryProtocol {
  ...
  Future<void> remove() async {
    ...
    if (_platform == PlatformType.iOS ||
      ...
      try {
        ...
        debugPrint('TokenRepository remove ---->>> $e');
      }
    } else {
  ...
  Future<void> saveToken(Token token) async {
    ...
    if (_platform == PlatformType.iOS ||
      ...
      try {
        ...
        debugPrint('TokenRepository saveToken ---->>> $e');
      }
    } else {
  ...
  Future<Token?> fetchToken() async {
    ...
    try {
      ...
      debugPrint('TokenRepository fetchToken ---->>> $e');
